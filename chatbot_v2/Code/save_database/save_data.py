...
file_paths = [
    "./chatbot_v2/database/Luật/Luật Xử lý vi phạm hành chính/merged_data.json",
    "./chatbot_v2/database/Luật/Luật sửa đổi VPHC/sdbs.json",
    "./chatbot_v2/database/Luật/LUẬT  Hải quan/luathaiquan.json",
    "./chatbot_v2/database/Nghị_Định/nghidinh.json"
]
