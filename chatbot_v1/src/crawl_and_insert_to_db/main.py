...
chudes = load_json_file("./chatbot_v1/BoPhapDienDienTu/ChuDe.json")
...
demucs = load_json_file("./chatbot_v1/BoPhapDienDienTu/DeMuc.json")
with next(get_db()) as db:
    try:
...
tree_nodes = load_json_file("./chatbot_v1/BoPhapDienDienTu/TreeNode.json")

demuc_directory = os.fsencode("./chatbot_v1/BoPhapDienDienTu/demuc")
isSkipping = bool(checkpoint)

for file in os.listdir(demuc_directory):
    file_name = os.fsdecode(file)
    with open("./chatbot_v1/BoPhapDienDienTu/demuc/" + file_name, "r") as demuc_file:
